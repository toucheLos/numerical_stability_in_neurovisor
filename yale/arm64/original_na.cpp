...
#define nrn_init _nrn_init__original_na
#define _nrn_initial _nrn_initial__original_na
#define nrn_cur _nrn_cur__original_na
#define _nrn_current _nrn_current__original_na
#define nrn_jacob _nrn_jacob__original_na
#define nrn_state _nrn_state__original_na
#define _net_receive _net_receive__original_na 
#define rates rates__original_na 
#define states states__original_na 
...
#define alpha_m _ml->template fpfield<8>(_iml)
#define alpha_m_columnindex 8
#define beta_m _ml->template fpfield<9>(_iml)
#define beta_m_columnindex 9
#define alpha_h _ml->template fpfield<10>(_iml)
#define alpha_h_columnindex 10
#define beta_h _ml->template fpfield<11>(_iml)
...
static void register_nmodl_text_and_filename(int mechtype);
 ...
 {"setdata_original_na", _hoc_setdata},
 {"rates_original_na", _hoc_rates},
 {0, 0}
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 extern "C" void _original_na_reg() {
	int _vectorized = 1;
  _initlists();
 	ion_reg("na", -10000.);
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"alpha_m"} /* 8 */,
                                       _nrn_mechanism_field<double>{"beta_m"} /* 9 */,
                                       _nrn_mechanism_field<double>{"alpha_h"} /* 10 */,
                                       _nrn_mechanism_field<double>{"beta_h"} /* 11 */,
...
static int _reset;
static const char *modelname = "Original Sodium Channel (Minimal)";
...
static void _hoc_rates(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for rates_original_na. Requires prior call to setdata_original_na and that the specified mechanism instance still be in existence.", NULL);
  }
