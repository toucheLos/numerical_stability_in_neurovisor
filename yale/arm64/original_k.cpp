...
#define nrn_init _nrn_init__original_k
#define _nrn_initial _nrn_initial__original_k
#define nrn_cur _nrn_cur__original_k
#define _nrn_current _nrn_current__original_k
#define nrn_jacob _nrn_jacob__original_k
#define nrn_state _nrn_state__original_k
#define _net_receive _net_receive__original_k 
#define rates rates__original_k 
#define states states__original_k 
...
#define alpha_n _ml->template fpfield<6>(_iml)
#define alpha_n_columnindex 6
#define beta_n _ml->template fpfield<7>(_iml)
...
static void register_nmodl_text_and_filename(int mechtype);
 ...
 {"setdata_original_k", _hoc_setdata},
 {"rates_original_k", _hoc_rates},
 {0, 0}
};
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"alpha_n"} /* 6 */,
                                       _nrn_mechanism_field<double>{"beta_n"} /* 7 */,
...
static int _reset;
static const char *modelname = "Original Potassium Channel (Minimal, with vshift)";
...
static void _hoc_rates(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for rates_original_k. Requires prior call to setdata_original_k and that the specified mechanism instance still be in existence.", NULL);
  }
