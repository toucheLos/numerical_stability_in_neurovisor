...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 extern "C" void _low_calcium_reg() {
	int _vectorized = 1;
  _initlists();
 	ion_reg("ca", -10000.);
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       _nrn_mechanism_field<double>{"gTbar"} /* 0 */,
                                       _nrn_mechanism_field<double>{"ica"} /* 1 */,
                                       _nrn_mechanism_field<double>{"u"} /* 2 */,
                                       _nrn_mechanism_field<double>{"Du"} /* 3 */,
                                       _nrn_mechanism_field<double>{"eca"} /* 4 */,
                                       _nrn_mechanism_field<double>{"s_inf"} /* 5 */,
                                       _nrn_mechanism_field<double>{"u_inf"} /* 6 */,
                                       _nrn_mechanism_field<double>{"tau_u"} /* 7 */,
...
static int _reset;
static const char *modelname = "Original Low-Threshold Calcium Channel (T-type, Minimal)";
...
static void _initlists(){
 int _i; static int _first = 1;
  if (!_first) return;
 _slist1[0] = {u_columnindex, 0};  _dlist1[0] = {Du_columnindex, 0};
_first = 0;
}
