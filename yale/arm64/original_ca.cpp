...
#define nrn_init _nrn_init__original_ca
#define _nrn_initial _nrn_initial__original_ca
#define nrn_cur _nrn_cur__original_ca
#define _nrn_current _nrn_current__original_ca
#define nrn_jacob _nrn_jacob__original_ca
#define nrn_state _nrn_state__original_ca
#define _net_receive _net_receive__original_ca 
#define rates rates__original_ca 
#define states states__original_ca 
...
#define q _ml->template fpfield<2>(_iml)
#define q_columnindex 2
#define r _ml->template fpfield<3>(_iml)
#define r_columnindex 3
#define Dq _ml->template fpfield<4>(_iml)
#define Dq_columnindex 4
#define Dr _ml->template fpfield<5>(_iml)
#define Dr_columnindex 5
#define eca _ml->template fpfield<6>(_iml)
#define eca_columnindex 6
#define alpha_q _ml->template fpfield<7>(_iml)
#define alpha_q_columnindex 7
#define beta_q _ml->template fpfield<8>(_iml)
#define beta_q_columnindex 8
#define alpha_r _ml->template fpfield<9>(_iml)
#define alpha_r_columnindex 9
#define beta_r _ml->template fpfield<10>(_iml)
#define beta_r_columnindex 10
...
static void register_nmodl_text_and_filename(int mechtype);
 ...
 {"setdata_original_ca", _hoc_setdata},
 {"rates_original_ca", _hoc_rates},
 {0, 0}
};
...
static NPyDirectMechFunc npy_direct_func_proc[] = {
 ...
 {"gcabar_original_ca", "mS/cm2"},
 {"ica_original_ca", "mA/cm2"},
 {0, 0}
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 extern "C" void _original_ca_reg() {
	int _vectorized = 1;
  _initlists();
 	ion_reg("ca", -10000.);
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"q"} /* 2 */,
                                       _nrn_mechanism_field<double>{"r"} /* 3 */,
                                       _nrn_mechanism_field<double>{"Dq"} /* 4 */,
                                       _nrn_mechanism_field<double>{"Dr"} /* 5 */,
                                       _nrn_mechanism_field<double>{"eca"} /* 6 */,
                                       _nrn_mechanism_field<double>{"alpha_q"} /* 7 */,
                                       _nrn_mechanism_field<double>{"beta_q"} /* 8 */,
                                       _nrn_mechanism_field<double>{"alpha_r"} /* 9 */,
                                       _nrn_mechanism_field<double>{"beta_r"} /* 10 */,
...
static int _reset;
static const char *modelname = "Original Calcium Channel (Minimal)";
...
/*CVODE*/
 ...
 static int _ode_matsol1 (_internalthreadargsproto_) {
 rates ( _threadargscomma_ v ) ;
 Dq = Dq  / (1. - dt*( ( alpha_q )*( ( ( - 1.0 ) ) ) - ( beta_q )*( 1.0 ) )) ;
 Dr = Dr  / (1. - dt*( ( alpha_r )*( ( ( - 1.0 ) ) ) - ( beta_r )*( 1.0 ) )) ;
  return 0;
}
 /*END CVODE*/
 static int states (_internalthreadargsproto_) { {
   rates ( _threadargscomma_ v ) ;
    q = q + (1. - exp(dt*(( alpha_q )*( ( ( - 1.0 ) ) ) - ( beta_q )*( 1.0 ))))*(- ( ( alpha_q )*( ( 1.0 ) ) ) / ( ( alpha_q )*( ( ( - 1.0 ) ) ) - ( beta_q )*( 1.0 ) ) - q) ;
    r = r + (1. - exp(dt*(( alpha_r )*( ( ( - 1.0 ) ) ) - ( beta_r )*( 1.0 ))))*(- ( ( alpha_r )*( ( 1.0 ) ) ) / ( ( alpha_r )*( ( ( - 1.0 ) ) ) - ( beta_r )*( 1.0 ) ) - r) ;
   }
  return 0;
}
